...
function ReportBody({ report, branchName }: { report: { overall: number; advantages: string[]; improvements: string[]; dimensions: import('../types').Report['dimensions']; efficiency: import('../types').EfficiencyResult }; branchName: string }) {
    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <section className="rounded-xl border border-slate-200 bg-white p-4">
          ...
          <ScoreRadar report={report as import('../types').Report} />
        </section>
